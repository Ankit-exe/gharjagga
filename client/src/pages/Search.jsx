    ...
    <div className="flex flex-col md:flex-row">
      <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen font-normal">
        <form className="flex flex-col gap-8">
          ...
          <button className="bg-green-700 text-white p-3 rounded-lg uppercase hover:opacity-95">Search</button>
        </form>
      </div>
      <div className="">
        <h1 className="text-3xl font-medium border-b text-green-700 mt-5 p-3">Listing Results:</h1>
      </div>
    </div>
  );
}
